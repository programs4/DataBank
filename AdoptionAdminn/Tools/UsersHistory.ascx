<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UsersHistory.ascx.cs" Inherits="AdoptionAdminn_Tools_UsersHistory" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <ul class="FilterSearch">         
            <li>İstifadəçi adı:
                            <br />
                <asp:DropDownList ID="DListUsersName" CssClass="form-control" runat="server" DataTextField="Username" DataValueField="ID" Width="250px"></asp:DropDownList></li>
        ...
        <asp:GridView ID="GrdHistory" runat="server" AutoGenerateColumns="False" BorderColor="#CDCDCD" BorderWidth="0px" CellPadding="4" ForeColor="#051615" Width="100%" CssClass="boxShadow" Font-Bold="True" Style="margin-top: 15px">
            <Columns>
                ...
                <asp:BoundField DataField="FullName" HeaderText="İstifadəçi S.A.A">
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left" Width="250px" />
                </asp:BoundField>
