<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Main.ascx.cs" Inherits="AdoptionAdminn_Tools_Main" %>
    ...
    <ContentTemplate>
        ...
        <ul id="myTab" class="nav nav-pills" role="tablist" style="background-color: #F9F9F9; padding: 5px; border: 1px solid #E4E4E4;">
            ...
            <li role="presentation" class=""><a href="#password" role="tab" id="password-tab" data-toggle="tab" aria-controls="password" aria-expanded="true">
              ...
              <li role="presentation" class=""><a href="#contents" role="tab" id="contents-tab" data-toggle="tab" aria-controls="contents" aria-expanded="true">
                <span class="glyphicon glyphicon-text-size"></span>&nbsp;&nbsp;Giriş mətni</a></li>
        ...
        <div id="myTabContent" class="tab-content" style="padding: 10px 0px 10px 3px; margin-top: 5px">
            ...
            <div role="tabpanel" class="tab-pane fade" id="password" aria-labelledby="password-tab">
              ...
              <div role="tabpanel" class="tab-pane fade" id="contents" aria-labelledby="contents-tab">
                <asp:Panel ID="PnlSiteContent" runat="server" BackColor="#EFEFEF" CssClass="textBox" DefaultButton="BtnSaveContent">
                    <div class="panel panel-default">
                        <div class="panel-heading">Saytın giriş mətni</div>
                        <div class="panel-body">
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                <ContentTemplate>
                                     Mətnin başlığı:<br />
                                       <asp:TextBox ID="TxtContentTitle" runat="server" CssClass="form-control" Height="35px" Width="70%"></asp:TextBox>
                                        <br />
                                        <br />     
                                     Mətnin məzmunu:<br />                              
                                    <asp:TextBox ID="TxtContent" runat="server" CssClass="form-control" Height="150px" TextMode="MultiLine" Width="70%"></asp:TextBox>
                                    <br />
                                    <br />
                                    <br />
                                    <asp:Button ID="BtnSaveContent" runat="server" CssClass="btn btn-default" Height="35px"  Text="YADDA SAXLA" OnClick="BtnSaveContent_Click" Width="160px" />
                                </ContentTemplate>
                            </asp:UpdatePanel>
                            <br />
                        </div>
