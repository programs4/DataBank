<%@ Control Language="C#" AutoEventWireup="true" CodeFile="280_TerbiyeviTedbir.ascx.cs" Inherits="Detail_Contents_280_TerbiyeviTedbir" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="PnlEdit" Visible="false" runat="server" CssClass="ContentRoot">
            ...
            <asp:TextBox ID="TxtMuessiseAdi" CssClass="form-control .col-md-6" Width="100%" runat="server"></asp:TextBox>
                ...
                <br />
                Tətbiq tarixi<br />
                <asp:DropDownList ID="DListTedbiqD" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="ID" Width="100px">
                </asp:DropDownList>
                <asp:DropDownList ID="DListTedbiqM" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="ID" Width="250px">
                </asp:DropDownList>
                <asp:DropDownList ID="DListTedbiqY" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="ID" Width="150px">
                </asp:DropDownList>
                <br />
                <br />
        ...
        <asp:GridView ID="GrdList" runat="server" BorderColor="#EAEAEA" CellPadding="4" ForeColor="#051615" Width="100%" Font-Bold="True" DataKeyNames="ID" AutoGenerateColumns="False" OnRowDeleting="GrdList_RowDeleting" OnSelectedIndexChanged="GrdList_SelectedIndexChanged">
            <Columns>
                ...
                <asp:BoundField DataField="TetbiqTarixi" HeaderText="Tətbiq tarixi">
