<%@ Control Language="C#" AutoEventWireup="true" CodeFile="160_SehiyyeMualice.ascx.cs" Inherits="Detail_Contents_160_SehiyyeMualice" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="PnlEdit" Visible="false" runat="server" CssClass="ContentRoot">
            ...
            <asp:TextBox ID="TxtMuessiseAdi" CssClass="form-control .col-md-6" Width="100%" runat="server"></asp:TextBox>
                ...
                <br />
                Telefon<br />
                <asp:TextBox ID="TxtPhone" runat="server" CssClass="form-control .col-md-6" Width="100%"></asp:TextBox>
                <br />
                <br />
                Müalicə tarixi<br />
                <asp:DropDownList ID="DListMualiceD" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="ID" Width="100px">
                </asp:DropDownList>
                <asp:DropDownList ID="DListMualiceM" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="ID" Width="250px">
                </asp:DropDownList>
                <asp:DropDownList ID="DListMualiceY" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="ID" Width="150px">
                </asp:DropDownList>
                <br />
                <br />
                ...
                <br />
                <br />
                Tibb bacısının soyadı və adı<br />
                <asp:TextBox ID="TxtTibbBacısıFullName" runat="server" CssClass="form-control .col-md-6" Width="100%"></asp:TextBox>
                <br />
                <br />
                Tibb bacısının telefon nömrəsi<br />
                <asp:TextBox ID="TxtTibbBacısıPhone" runat="server" CssClass="form-control .col-md-6" Width="100%"></asp:TextBox>
                <br />
                <br />
                Qeyd<br />
        ...
        <asp:GridView ID="GrdList" runat="server" BorderColor="#EAEAEA" CellPadding="4" ForeColor="#051615" Width="100%" Font-Bold="True" DataKeyNames="ID" AutoGenerateColumns="False" OnRowDeleting="GrdList_RowDeleting" OnSelectedIndexChanged="GrdList_SelectedIndexChanged">
            <Columns>
                ...
                <asp:BoundField DataField="MualiceTarixi" HeaderText="Müalicə tarixi">
                    <HeaderStyle HorizontalAlign="Center" Width="140px" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="TibbIshcisiSoyadAd" HeaderText="Tibb bacısının S.A" />
                <asp:BoundField DataField="TibbIshcisiTelefon" HeaderText="Telefon">
                    <HeaderStyle HorizontalAlign="Center" Width="140px" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
