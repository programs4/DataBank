<%@ Control Language="C#" AutoEventWireup="true" CodeFile="200_IdmanDerney.ascx.cs" Inherits="Detail_Contents_200_IdmanDerney" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="PnlEdit" Visible="false" runat="server" CssClass="ContentRoot">
            <div class="PnlItems">
                Dərnəyin adı
                <asp:TextBox ID="TxtAd" CssClass="form-control .col-md-6" Width="100%" runat="server"></asp:TextBox>
                <br />
                <br />
                Ünvan<br />
                ...
                <br />
                Üzv tarixi<br />
                <asp:DropDownList ID="DListUzvTarixiD" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="ID" Width="100px">
                </asp:DropDownList>
                <asp:DropDownList ID="DListUzvTarixiM" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="ID" Width="250px">
                </asp:DropDownList>
                <asp:DropDownList ID="DListUzvTarixiY" runat="server" CssClass="form-control" DataTextField="Name" DataValueField="ID" Width="150px">
                </asp:DropDownList>
                <br />
                <br />
                Qeyd<br />
        ...
        <asp:GridView ID="GrdList" runat="server" BorderColor="#EAEAEA" CellPadding="4" ForeColor="#051615" Width="100%" Font-Bold="True" DataKeyNames="ID" AutoGenerateColumns="False" OnRowDeleting="GrdList_RowDeleting" OnSelectedIndexChanged="GrdList_SelectedIndexChanged">
            <Columns>
                ...
                <asp:BoundField DataField="Adi" HeaderText="Dərnəyin adı" />
                <asp:BoundField DataField="UzvTarix" HeaderText="Üzv tarixi">
