<%@ Control Language="C#" AutoEventWireup="true" CodeFile="190_IdmanNailiyyet.ascx.cs" Inherits="Detail_Contents_190_IdmanNailiyyet" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="PnlEdit" Visible="false" runat="server" CssClass="ContentRoot">
            ...
            <asp:TextBox ID="TxtYarisAd" CssClass="form-control .col-md-6" Width="100%" runat="server"></asp:TextBox>
                ...
                <br />
                İdman növü<br />
                <asp:DropDownList ID="DListIdmanNov" runat="server" AutoPostBack="True" CssClass="form-control .col-md-6" DataTextField="Name" DataValueField="ID"  Width="100%">
                </asp:DropDownList>
                <br />
                <br />
                Yarış tarixi<br />
        ...
        <asp:GridView ID="GrdList" runat="server" BorderColor="#EAEAEA" CellPadding="4" ForeColor="#051615" Width="100%" Font-Bold="True" DataKeyNames="ID" AutoGenerateColumns="False" OnRowDeleting="GrdList_RowDeleting" OnSelectedIndexChanged="GrdList_SelectedIndexChanged">
            <Columns>
                ...
                <asp:BoundField DataField="YarisAdi" HeaderText="Yarışın adı" />
                <asp:BoundField DataField="IdmanNov" HeaderText="İdaman növü" />
                <asp:BoundField DataField="Unvan" HeaderText="Yarışın keçirildiyi ünvan" HtmlEncode="False" />
                <asp:BoundField DataField="YarisTarixi" HeaderText="Yarış tarixi">
